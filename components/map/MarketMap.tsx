...
export default function MarketMap({ stalls, selectedStallId, onStallSelect, showAdminLinks = false }: MarketMapProps) {
    ...
    >
      <div style={{
        ...
        {stalls.map(stall => {
          ...
          return (
            <button key={stall.id} onClick={(e) => { e.stopPropagation(); flyToStall(stall); }} onPointerDown={(e) => e.stopPropagation()}
              style={{
